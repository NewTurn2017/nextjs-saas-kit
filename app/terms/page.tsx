        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 space-y-8">
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              이 약관은 스타터킷(이하 "회사")이 제공하는 모든 서비스(이하 "서비스")의 이용조건 및 절차에 관한 사항과 
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2 text-gray-600">
              ...
              <li>"아이디(ID)"란 회원의 식별과 서비스 이용을 위하여 회원이 정하고 회사가 승인한 이메일 주소를 의미합니다.</li>
              <li>"비밀번호"란 회원이 부여받은 아이디와 일치되는 회원임을 확인하기 위해 회원 자신이 정한 문자 또는 숫자의 조합을 의미합니다.</li>
            </ol>
          </section>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-2 text-gray-600">
              <li>회원가입은 신청자가 이 약관에 동의하고 회사가 정한 가입 양식에 따라 회원정보를 기입하여 가입을 신청합니다.</li>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed mb-2">회원은 다음 행위를 하여서는 안 됩니다.</p>
            <ol className="list-decimal list-inside space-y-2 text-gray-600">
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed">
              회사는 회원의 개인정보를 보호하기 위하여 "개인정보 처리방침"을 제정하여 운영하고 있으며, 
              개인정보 보호에 관한 자세한 사항은 회사의 개인정보 처리방침을 참조하시기 바랍니다.
            </p>
          </section>
