        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 space-y-8">
          <section>
            <p className="text-gray-600 leading-relaxed mb-6">
              스타터킷(이하 "회사")은 정보주체의 자유와 권리 보호를 위해 「개인정보 보호법」 및 관계 법령이 정한 바를 준수하여, 
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">제1조 (개인정보의 처리목적)</h2>
            <p className="text-gray-600 leading-relaxed mb-2">회사는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.</p>
            <ol className="list-decimal list-inside space-y-2 text-gray-600">
              <li><strong>회원 가입 및 관리:</strong> 회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 서비스 부정이용 방지, 각종 고지·통지 등</li>
              <li><strong>서비스 제공:</strong> 서비스 제공, 콘텐츠 제공, 맞춤서비스 제공, 본인인증 등</li>
              <li><strong>고충처리:</strong> 민원인의 신원 확인, 민원사항 확인, 사실조사를 위한 연락·통지, 처리결과 통보 등</li>
            </ol>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">제2조 (개인정보의 처리 및 보유기간)</h2>
            <p className="text-gray-600 leading-relaxed mb-2">회사는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.</p>
            <ol className="list-decimal list-inside space-y-2 text-gray-600">
              <li><strong>회원 가입 및 관리:</strong> 회원 탈퇴 시까지</li>
              <li><strong>서비스 제공:</strong> 서비스 공급 완료 및 요금 결제·정산 완료 시까지</li>
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed mb-2">회사는 다음의 개인정보 항목을 처리하고 있습니다.</p>
            <ol className="list-decimal list-inside space-y-2 text-gray-600">
              ...
              <li><strong>소셜 로그인 시 (Google)</strong>
                <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">제5조 (개인정보의 파기절차 및 방법)</h2>
            <p className="text-gray-600 leading-relaxed mb-2">회사는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.</p>
            <ol className="list-decimal list-inside space-y-2 text-gray-600">
          ...
          <section>
            ...
            <p className="text-gray-600 leading-relaxed mb-2">정보주체는 회사에 대해 언제든지 개인정보 보호 관련 권리를 행사할 수 있습니다.</p>
            <ol className="list-decimal list-inside space-y-2 text-gray-600">
              <li>개인정보 열람요구</li>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">제7조 (개인정보의 안전성 확보조치)</h2>
            <p className="text-gray-600 leading-relaxed mb-2">회사는 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.</p>
            <ol className="list-decimal list-inside space-y-2 text-gray-600">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">제8조 (개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">제9조 (개인정보 보호책임자)</h2>
            <p className="text-gray-600 leading-relaxed mb-2">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">제10조 (개인정보 처리방침 변경)</h2>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="border-t pt-8">
            <p className="text-gray-600 text-center">
              <strong>공고일자:</strong> 2024년 1월 1일
            </p>
